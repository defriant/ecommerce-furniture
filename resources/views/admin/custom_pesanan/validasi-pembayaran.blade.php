    ...
    <div class="container-fluid">
        ...
        <div class="panel panel-headline">
            <div class="panel-heading">
                <h4 class="pesanan-title"><b>CUSTOM PESANAN / <span style="color: #00AAFF">VALIDASI PEMBAYARAN</span></b></h4>
            </div>
            <div class="panel-body" style="margin-top: 20px">
                <div class="row">
                    <div class="pesanan-list">
                        <div id="custom-validasi-pembayaran-data">
                            @include('admin.custom_pesanan.validasi-pembayaran-data')
                        </div>
                    </div>
                </div>
            </div>
