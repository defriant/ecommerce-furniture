                    ...
                    <div class="panel-body">
                        ...
                        <div class="col-xs-12 col-md-4 detail-harga">
                            ...
                            <div class="detail-pesanan-harga">
                                <h5>Total Belanja</h5>
                                <br>
                                <h4><b>Rp {{ number_format($data->total) }}</b></h4>
                            </div>
                        </div>
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div class="col-xs-12 col-md-8 barang">
                            ...
                            <div class="col-xs-12 col-sm-6">
                                <div class="pesanan-item">
                                    ...
                                    <ul style="list-style-type: none">
                                        <li><h5 style="font-size: 12px; margin-left: 10px; margin-top: 10px">Rp {{ number_format($pb->harga) }}</h5></li>
                                        <li><h5 style="font-size: 12px; margin-left: 10px; margin-top: 10px">{{ $pb->jumlah }} Barang</h5></li>
                                    </ul>
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-6" style="text-align: center">
                                @if ($data->status == 'menunggu_konfirmasi')
                                <h5 style="font-size: 13px; margin-bottom: 10px">Estimasi Pengerjaan :</h5>
                                <h5 style="font-size: 14px; opacity: .3"><b>Menunggu Konfirmasi</b></h5>
                                @elseif($data->status == 'konfirmasi' || $data->status == 'menunggu_validasi' || $data->status == 'validasi')
                                <h5 style="font-size: 13px; margin-bottom: 10px">Estimasi Pengerjaan :</h5>
                                <h5 style="font-size: 13px">{{ date('d M Y', strtotime($data->estimasi_stok)) }}</h5>
                                @elseif ($data->status == 'stok_ready' || $data->status == 'pengiriman' || $data->status == 'tiba_di_tujuan')
                                <h5 style="font-size: 13px; margin-bottom: 10px"><i class="fas fa-check"></i> Pengerjaan Selesai</h5>
                                @endif
                            </div>
                            ...
                            <div class="col-xs-12" style="margin-top: 7px">
                                <h5 style="font-size: 13px; margin-bottom: 7px">Detail Barang :</h5>
                                <h5 style="font-size: 13px; line-height: 18px; white-space: pre-line">{{ $pb->detail_barang }}</h5>
                            </div>
                            @endforeach
                        </div>
                        <div class="col-xs-12 col-md-4 detail-harga">
                            ...
                            <div class="detail-pesanan-harga">
                                ...
                                <br>
                                @if($data->status == 'batal')
                                    <h4 style="opacity: .3"><b>Dibatalkan</b></h4>
                                @else
                                    <h4><b>Rp {{ number_format($data->total) }}</b></h4>
                                @endif
                            </div>
                        ...
                        <div class="col-xs-12 status-pesanan">
                            ...
                            <h4 style="text-align: center; color: orange; margin-top: 50px; margin-bottom: 30px;">STATUS PESANAN</h4>
                            <div id="status-pesanan-{{ $data->id }}">
                                @include('user.status-pesanan-custom')
                            </div>
                        </div>
                    </div>
                </div>
