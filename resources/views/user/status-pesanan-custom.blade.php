    ...
    <div class="status-pesanan-list">
        ...
        <div class="status-pesanan-item">
            ...
            <div class="status-pesanan-item-done">
                ...
                <h5 style="font-size: 12px; margin-bottom: 4px">Pesanan dikonfirmasi.</h5>
                <h5 style="font-size: 12px">Estimasi pengerjaan hingga {{ date("d M Y", strtotime($data->estimasi_stok)) }}.</h5>
            </div>
        </div>
    </div>
...
<div class="status-pesanan-list" style="margin-top: -25px">
    ...
    <div class="status-pesanan-item">
        ...
        <div class="status-pesanan-item-validasi-invalid">
            <h5 style="font-size: 12px">Bukti pembayaran anda tidak valid, upload ulang.</h5>
        </div>
    </div>
</div>
...
<div class="status-pesanan-list" style="margin-top: -25px">
    <i class="far fa-spinner fa-pulse icon-bg-color status-pesanan-icon-process"></i>
    <div class="status-pesanan-item">
        <h5 class="status-pesanan-process"><b>PENGERJAAN PESANAN</b></h5>
        <div class="status-pesanan-item-process">
            <h5 style="font-size: 12px">Estimasi pengerjaan hingga {{ date("d M Y", strtotime($data->estimasi_stok)) }}.</h5>
        </div>
    </div>
...
<div class="status-pesanan-list" style="margin-top: -25px">
    <i class="far fa-check icon-bg-color status-pesanan-icon-done"></i>
    <div class="status-pesanan-item">
        <h5 class="status-pesanan-done"><b>PENGERJAAN PESANAN</b></h5>
        <div class="status-pesanan-item-process">
            <h5 style="font-size: 12px">Estimasi pengerjaan hingga {{ date("d M Y", strtotime($data->estimasi_stok)) }}.</h5>
        </div>
        <div class="status-pesanan-item-done">
            <h5 style="font-size: 11px; margin-bottom: 7px">{{ date("d M Y H:i", strtotime($data->stok_ready)) }}</h5>
            <h5 style="font-size: 12px">Barang sudah siap untuk dikirim.</h5>
        </div>
    </div>
</div>
