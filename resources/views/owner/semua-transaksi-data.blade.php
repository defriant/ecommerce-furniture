    ...
    <tr style="background: rgb(250, 250, 250)">
        ...
        <td>
            @if ($p->jenis_pesanan == 'pesanan')
                <i class="fas fa-shopping-bag" style="margin-right: 5px; color: coral"></i>Pesanan
            @else
                <i class="far fa-shopping-bag" style="margin-right: 5px; color: coral"></i>Custom Pesanan
            @endif
        </td>
        <td>{{ $p->nama }}</td>
